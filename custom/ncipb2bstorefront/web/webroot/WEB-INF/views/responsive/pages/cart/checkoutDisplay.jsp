...
<div class="row pb-4">
    ...
    <div class="col-lg-6 l-gray p-4 cart-actions--print">
        <div >
            	<h4><spring:theme code="text.expresscheckout.header"/></h4>
			<h6><spring:theme code="text.expresscheckout.title"/></h6>
			   <spring:theme code="text.expresscheckout.line1"/><br>
			   <spring:theme code="text.expresscheckout.line2"/><br>
			   <spring:theme code="text.expresscheckout.line3"/>
...
<!-- <div class="cart__actions"> -->
    <div class="row pb-3">
		...
		<div class="col-lg-3 mb-2">
            <button class="btn btn-secondary btn-block js-continue-shopping-button" data-continue-shopping-url="${fn:escapeXml(continueShoppingUrl)}">
        ...
        <div class="col-lg-3 mb-2">
            <ycommerce:testId code="checkoutButton">
                <button class="btn btn-primary btn-block js-continue-checkout-button" data-checkout-url="${fn:escapeXml(checkoutUrl)}">
