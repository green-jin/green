...
<div class="col-lg-10 container-fluid">
	...
	<div class="row justify-content-between p-3">
		...
		<a href="add-address"><spring:theme
				code="text.account.addressBook.addAddress" /></a>
	</div>
	<hr>
	<div class="row p-3">
			...
			<div class="col-md-4 border border-l-gary p-3">
				<div class="row">
					<div class="col-9 text-left">
						<h6>${fn:escapeXml(address.title)}&nbsp;${fn:escapeXml(address.firstName)}&nbsp;${fn:escapeXml(address.lastName)}<c:if
								test="${address.defaultAddress}">(<spring:theme
					...
					<div class="col-3 text-right text-secondary">
						...
						<ycommerce:testId code="addressBook_removeAddress_button">
							<a href="#"
								class="action-links removeAddressFromBookButton text-secondary"
								data-address-id="${fn:escapeXml(address.id)}"
								data-popup-title="<spring:theme code="text.address.delete.popup.title" />">
								<span class="glyphicon glyphicon-remove fa fa-times"></span>
							</a>
						</ycommerce:testId>
					</div>
				</div>
