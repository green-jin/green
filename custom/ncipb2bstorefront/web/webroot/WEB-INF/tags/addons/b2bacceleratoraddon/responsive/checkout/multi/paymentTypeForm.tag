    ...
    <div class="step-body-form">
        <div class="radiobuttons_paymentselection">
            <c:forEach items="${paymentTypes}" var="paymentType">
           		<c:if test="${paymentType.code != 'CARD'}"> 
       ...
       <formElement:formInputBox idKey="PurchaseOrderNumber" labelKey="checkout.multi.purchaseOrderNo.label" path="purchaseOrderNumber" inputCSS="text" />
