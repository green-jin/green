        ...
        <c:forEach begin="1" end="${quickOrderMinRows}">
            <li class="item__list--item js-li-container">
	            <div class="row p-2 no-gutters">
	                ...
	                <div class="col-md-9 row d-flex justify-content-end no-gutters">
...
<div class="col-md-9 row mb-2 no-gutters">
	...
	<div class="btn-group py-3 item__quantity js-product-info" role="group" aria-label="First group">
		<button type="button" class="col-md-2 btn btn-secondary" onclick="minusFunction({{= ncipProductCode}})">-</button>
		<input id="quantityNumber{{= ncipProductCode}}" type="text" class="js-quick-order-qty col-md-5 form-control" value="1" maxlength="3" size="1"
		...
		<%-- <div class="js-product-info js-qty-validation-container help-block quick-order__help-block" data-max-product-qty-msg="${maxProductQtyMsgHtml}"></div> --%>
		<button type="button" class="col-md-2 btn btn-secondary" onclick="plusFunction({{= ncipProductCode}})">+</button>
	</div>
	</div>
	...
	<div class="item__remove col-md-1 d-none d-md-block align-self-center no-gutters text-center">
		<button id={{= ncipProductCode}} class="btn js-remove-quick-order-row" tabindex="-1" onclick="clearRowEvent(this.id)">
			<span class="glyphicon glyphicon-remove fa fa-times text-primary"></span>
		</button>
	</div>
	</div>
