...
<spring:htmlEscape defaultHtmlEscape="true" />
	...
	<c:set var="productCodeHtml"
		value="${fn:escapeXml(entry.product.code)}" />
...
<tr>
							...
							<c:if
								...
								<div class="promo">
									<ycommerce:testId code="cart_potentialPromotion_label">
										<span class="text-success">${ycommerce:sanitizeHTML(promotion.description)}</span>
									</ycommerce:testId>
								</div>
							</c:if>
						</c:forEach>
		...
		<td class="text-center align-middle">
			<%-- total --%> <ycommerce:testId code="cart_totalProductPrice_label">
						...
						<ul style="list-style-type: none">
							...
							<c:forEach var="entryAction" items="${entry.supportedActions}">
								...
								<li class="js-execute-entry-action-button"
									...
									<a href="#" class="text-secondary"><i class="fa fa-trash"></i></a>
								</li>
							</c:forEach>
						</ul>
					</div>
		...
		<li class="item__list--comment" style="list-style:none;">
