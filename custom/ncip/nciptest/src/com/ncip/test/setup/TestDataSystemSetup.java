...
import com.ncip.test.constants.NcipTestConstants;
import com.ncip.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = NcipTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/nciptest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/nciptest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/nciptest/import/cstickets.impex");
			...
			importImpexFile(context, "/nciptest/import/csquotes.impex");
		}
	}
}
