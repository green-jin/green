 ...
 */
package com.ncip.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(NcipFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(NcipFulfilmentProcessConstants.PARENT_PROCESS);
