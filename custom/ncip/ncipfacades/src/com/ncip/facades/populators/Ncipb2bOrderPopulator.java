 ...
 */
public class Ncipb2bOrderPopulator extends AbstractOrderPopulator<OrderModel, OrderData>{
	...
	public void populate(final OrderModel source, final OrderData target)
	{
        ...
        target.setVkorg(source.getVkorg());
        target.setPernr(source.getPernr());
        target.setLifnr(source.getLifnr());
