 ...
 */
package com.ncip.facades.account.impl;
 ...
 */
public class DefaultNcipCustomerFacade extends DefaultCustomerFacade
{
	private static final Logger LOG = Logger.getLogger(DefaultNcipCustomerFacade.class);

	private UserService userService;
	private NcipCustomerAccountService ncipCustomerAccountService;
	...
	public void updateProfile(final CustomerData customerData) throws DuplicateUidException
	{
		...
		getNcipCustomerAccountService().updateProfile(customer, customerData, customerData.getTitleCode(), name, customerData.getUid());
	}
	...
	public NcipCustomerAccountService getNcipCustomerAccountService() {
      return ncipCustomerAccountService;
	}

	@Required
	public void setNcipCustomerAccountService(NcipCustomerAccountService ncipCustomerAccountService) {
      this.ncipCustomerAccountService = ncipCustomerAccountService;
    }
