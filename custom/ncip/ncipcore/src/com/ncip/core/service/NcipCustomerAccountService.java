 ...
 */
public interface NcipCustomerAccountService extends CustomerAccountService
{
	/**
	 ...
	 *            the illegal argument exception is thrown when given payment info does not belong to the given customer
	 *            or any argument is null
	 * @deprecated Since 6.7. Use {@link NcipCustomerAccountService#deleteCCPaymentInfo(CustomerModel, CreditCardPaymentInfoModel)}
	 */
	@Deprecated
	 ...
	 */
	void updateProfile(CustomerModel customerModel, CustomerData customerData, String titleCode, String name, String login) throws DuplicateUidException;
