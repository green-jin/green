...
{
	private static final Logger LOG = Logger.getLogger(ApprovalProcessStartAction.class);
	...
	{
		LOG.debug("##### [custom b2borderapproval.xml] ApprovalProcessStartAction executeAction Start ##### orderProcessCode:"
